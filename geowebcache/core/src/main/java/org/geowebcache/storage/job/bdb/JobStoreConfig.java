...
/**
 * Responsible for maintaining the configuration of the JobStore.
 * 
 * @author mleslie
 */
...
public void setCacheMemoryPercentAllowed(Integer allowed) {
    this.cacheMemoryPercentAllowed = allowed;
}
...
public void setCacheSizeMB(Integer size) {
