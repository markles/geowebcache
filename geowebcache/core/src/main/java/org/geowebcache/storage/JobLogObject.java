...
/**
 * POJO containing details of a single job log object, used to serve and persist the logs.
 */
public class JobLogObject {
    ...
    public boolean equals(Object obj) {
        if(obj instanceof JobLogObject) {
            JobLogObject other = (JobLogObject)obj;
            boolean result = this.jobLogId == other.jobLogId &&
                    this.jobId == other.jobId &&
                    this.logLevel == other.logLevel &&
                    Objects.equal(this.logSummary, other.logSummary) &&
                    Objects.equal(this.logText, other.logText) &&
                    Objects.equal(this.logTime, other.logTime);
            return true;
        }
        return false;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(jobId, jobLogId, logLevel, logSummary, logText, logTime);
    }
}
