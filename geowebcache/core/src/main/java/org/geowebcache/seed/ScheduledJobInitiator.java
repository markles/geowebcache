...
/**
 * Responsible for kicking off the execution of jobs.  This includes handling once-off, scheduled
 * and restarted jobs and ensuring that the jobstore is kept up to date.
 */
public class ScheduledJobInitiator implements Runnable {
    ...
    private boolean spawnedJobAlreadyRunning() {
        Iterator<GWCTask> iter = seeder.getRunningTasks();
